...
### 🎯 **Smart Tracking**
- ✅ Problem tracking with patterns
...
```
dsa-tracker/
├── 📄 dsatracker.html          # Main application
├── 📄 neetcode.html             # NeetCode 150 problems
├── 📄 striver.html              # Striver SDE 191 sheet
├── 📄 visualize.html            # Algorithm visualizer
├── 📂 api/
│   ├── contests.js              # Contest API handler
...
| Metric | Description |
|--------|-------------|
| 📈 **Total Problems** | All problems you've attempted |
| ✅ **Solved** | Problems solved independently |
| 🔄 **Due for Review** | Spaced repetition reminders |
| 🔥 **Daily Streak** | Consecutive days of practice |
| ⏱️ **Avg Solve Time** | Your average completion time |
...
- 🔐 **Private Data**: Your data stays yours
- ☁️ **Optional Cloud Sync**: Use local storage only if preferred
